  ...
  outputs = {
      ...
      forAllSystems = function:
        nixpkgs.lib.genAttrs [
          ...
          "aarch64-darwin"
            ...
            rustle = craneLib.buildPackage (craneCommon
              // {
    ...
    in {
      checks = forAllSystems ({
        ...
        rustle-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        rustle-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        rustle-audit = craneLib.cargoAudit {
      ...
      apps = forAllSystems ({system, ...}: {
        rustle = {
          type = "app";
          program = "${self.packages.${system}.rustle}/bin/rustle";
        };
        default = self.apps.${system}.rustle;
      });
